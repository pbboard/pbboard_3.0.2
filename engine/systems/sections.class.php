...
class PowerBBSection
{
	...
	function PowerBBSection($Engine)
	{
		$this->Engine = $Engine;
	}
          ...
          if (!$param['parent']== "0")
 	       {
		     ...
		     if ($cache)
			  {
	            // get main dir
				$file_forums_cache = $PowerBB->functions->GetMianDir()."cache/forums_cache_".$param['parent'].".php";
		      ...
		      if ($Cache)
 			  {
				  ...
				  $file_forums_cache = $PowerBB->functions->GetMianDir()."cache/forums_cache_".$Section['id'].".php";
                  $file_forums_cache = @str_ireplace("index.php/", '', $file_forums_cache);
                  $file_forums_cache = str_replace("index.php/", '', $file_forums_cache);
