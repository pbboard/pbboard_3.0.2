...
class PowerBBCoreMOD
{
	 ...
	 $PowerBB->_GET['subject_id'] = $PowerBB->functions->CleanVariable($PowerBB->_GET['subject_id'],'intval');
        ...
        $SectionInfo1 = $SubjectInfo['section'].$PowerBB->_GET['section'];
			...
			/** Get section's group information and make some checks **/
			 ...
			 {
	          $PowerBB->functions->error_no_foot($PowerBB->_CONF['template']['_CONF']['lang']['error_permission'].'');
			 }
    ...
    function _Edit_attach_Subject()
	{
		...
		// Get the attachment information
			...
			$PowerBB->_CONF['template']['while']['SubjectAttachList'] = $PowerBB->core->GetList($AttachArr,'attach');
	...
	function _Start_Edit_Subject()
	{
		global $PowerBB;
         ...
         $PowerBB->_GET['subject_id'] = $PowerBB->functions->CleanVariable($PowerBB->_GET['subject_id'],'intval');
			...
			{
			$PowerBB->functions->msg($PowerBB->_CONF['template']['_CONF']['lang']['File_was_downloaded_successfully']);
	 ...
	 function _Delete_Attach_Subject()
	{
		...
		{
		$PowerBB->functions->error_no_foot($PowerBB->_CONF['template']['_CONF']['lang']['File_was_deleted_successfully']);
		}
