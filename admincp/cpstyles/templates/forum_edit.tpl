...
<form action="index.php?page=forums&amp;edit=1&amp;start=1&amp;id={$Inf['id']}" method="post">
	<table width="90%" class="t_style_b" border="0" cellspacing="1" align="center">
		...
		<tr>
			...
			<td class="row2">
			<textarea name="describe" id="textarea_describe" rows="2" cols="66" dir="{$_CONF['info_row']['content_dir']}">{$Inf['section_describe']}</textarea>
			</td>
		</tr>
	</table>
...
<td class="row1">{$lang['Make_every_prefix_subject_in_a_line']}</td>
		<td class="row1">
<textarea name="prefix_subject" id="textarea_prefix_subject" rows="4" cols="57" wrap="virtual" dir="{$_CONF['info_row']['censorwords']}">{$Inf['prefix_subject']}</textarea>&nbsp;
</td>
</tr>		</tr>
	</table>
<br />
	...
	<table width="90%" class="t_style_b" border="0" cellspacing="1" align="center">
		...
		<tr align="center">
			<td class="row1" colspan="2">
				<textarea name="head" rows="6" cols="100" wrap="virtual" dir="{$_CONF['info_row']['content_dir']}">{$Inf['header']}</textarea>
			</td>
		</tr>
		<tr>
			<td class="main1" colspan="2">
		...
		<tr align="center">
			<td class="row1" colspan="2">
				<textarea name="foot" rows="6" cols="100" wrap="virtual" dir="{$_CONF['info_row']['content_dir']}">{$Inf['footer']}</textarea>
			</td>
		</tr>
           <tr align="center">
