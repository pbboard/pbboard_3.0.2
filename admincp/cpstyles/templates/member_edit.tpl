...
<br />
{/if}
<textarea name="avater_path" rows="1" cols="70" wrap="virtual" dir="ltr">{$avater_path}</textarea>
</td>
</tr>
<tr>
<td class="row1">
...
<br />
{/if}
<textarea name="profile_cover_photo" rows="1" cols="90" wrap="virtual" dir="ltr">{$profile_cover_photo}</textarea>
</td>
</tr>
<tr>
<td class="row2">
...
<td class="row2">
<textarea name="user_info" rows="1" cols="70" wrap="virtual" >{$Inf['user_info']}</textarea>
</td>
</tr>
<tr>
<td class="row2">
...
<td class="row1">
<textarea name="away_msg" rows="1" cols="70" wrap="virtual" dir="{$_CONF['info_row']['content_dir']}">{$Inf['away_msg']}</textarea>
</td>
</tr>
<tr>
<td class="row2">
...
<td class="row2">
<textarea name="user_country" rows="1" cols="70" wrap="virtual" >{$Inf['user_country']}</textarea>
</td>
</tr>
<tr>
<td class="row2">
...
<td class="row1">
<textarea name="website" rows="1" cols="70" wrap="virtual" dir="ltr">{$Inf['user_website']}</textarea>
</td>
</tr>
</table>
<br />
...
<textarea name="user_sig" rows="9" cols="80" wrap="virtual" >{$Inf['user_sig']}</textarea>&nbsp;
</td>
</tr>
</table>
<br />
