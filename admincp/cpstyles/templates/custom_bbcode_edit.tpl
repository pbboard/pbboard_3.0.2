...
<form action="index.php?page=custom_bbcode&amp;edit=1&amp;start=1&amp;id={$Custom_bbcodeEdit['id']}" method="post">
	<table width="98%" class="t_style_b" border="0" cellspacing="1" align="center">
		...
		<tr>
			...
			<td class="row2" valign="middle" width="60%">
			<textarea name="bbcode_desc" cols="60" rows="5" wrap="soft" id="bbcode_desc" class="multitext">{$Custom_bbcodeEdit['bbcode_desc']}</textarea></td>
		</tr>
		<tr>
			<td class="row2" valign="middle" width="40%">
			...
			<td class="row2" valign="middle" width="60%">
			<textarea name="bbcode_example" cols="60" rows="5" wrap="soft" id="bbcode_example" class="multitext">{$Custom_bbcodeEdit['bbcode_example']}</textarea></td>
		</tr>
		<tr>
			<td class="row2" valign="middle" width="40%">
			<b>{$lang['bbcode_tag']}</b>
...
{/if}
		...
		<tr>
			...
			<td class="row2" valign="middle" width="60%">
			<textarea name="bbcode_replace" cols="60" rows="5" wrap="soft" id="bbcode_replace" class="multitext">{$Custom_bbcodeEdit['bbcode_replace']}</textarea></td>
		</tr>
		<tr>
