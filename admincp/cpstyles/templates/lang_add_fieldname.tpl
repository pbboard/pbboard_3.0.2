...
<tr valign="top">
	...
	<textarea name="text" id="default_phrase" rows="5" cols="60" wrap="virtual" tabindex="1" dir="{$_CONF['info_row']['content_dir']}"></textarea></td></tr></table></td>
</tr>
<tr>
...
<tr valign="top">
	...
	<td class="row1"><textarea name="text_{$LangList['id']}" id="text_{$LangList['id']}" rows="5" cols="60" tabindex="1" wrap="virtual" dir="ltr"></textarea></td>
</tr>
{/Des::while}
<tr>
