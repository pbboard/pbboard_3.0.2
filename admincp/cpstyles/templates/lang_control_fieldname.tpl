...
<input type="button" class="submit" value="{$lang['Go']}" onclick="ob=this.form.fieldname;window.open(ob.options[ob.selectedIndex].value,'_self')" >
		...
		<td class="main2"><input type="text" class="bginput" name="perpage" value="{$perpage}" tabindex="1" size="5" /></td>
		<td class="main2"><input type="submit" class="button" value=" {$lang['Go']} " tabindex="1" accesskey="s" /></td>
		</form>
	</tr></table>

<table cellpadding="4" cellspacing="1" border="0" align="center" width="90%" style="border-collapse:separate" class="t_style_b">
<tr>
...
<tr valign="top" align="center">
	<td class="main2">{$lang['phrase_type']}</td>
	<td class="main2">{$lang_title}</td>
	<td class="main2" align="left">{$lang['edit']}</td>
	<td class="main2" align="right">{$lang['phrase_name']}</td>
...
<tr>
	<td class="main2" colspan="5" align="center">
<a class="input" href="index.php?page=lang&amp;search_fieldname=1&amp;main=1">{$lang['search_in_phrases']}</a>
		&nbsp; &nbsp;
&nbsp;
<a class="input" href="index.php?page=lang&amp;add_fieldname=1&amp;main=1">{$lang['add_new_phrase']}</a>
