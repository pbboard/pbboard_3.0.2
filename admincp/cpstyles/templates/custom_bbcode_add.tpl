...
<form action="index.php?page=custom_bbcode&amp;add=1&amp;start=1" method="post">
	<table width="98%" class="t_style_b" border="0" cellspacing="1" align="center">
		...
		<tr>
			...
			<td class="row1" valign="middle" width="60%">
			<textarea name="bbcode_desc" cols="60" rows="5" wrap="soft" id="bbcode_desc" class="multitext"></textarea></td>
		</tr>
		<tr>
			<td class="row1" valign="top" width="40%">
			...
			<td class="row1" valign="middle" width="60%">
			<textarea name="bbcode_example" cols="60" rows="5" wrap="soft" id="bbcode_example" class="multitext"></textarea></td>
		</tr>
		<tr>
			<td class="row1" valign="middle" width="40%">
			<b>{$lang['bbcode_tag']}</b>
...
<input name="bbcode_useoption1" value="0" checked id="red" type="radio">{$lang['no']}
		...
		<tr>
			...
			<td class="row1" valign="middle" width="60%">
			<textarea name="bbcode_replace" cols="60" rows="5" wrap="soft" id="bbcode_replace" class="multitext"></textarea></td>
		</tr>
		<tr>
