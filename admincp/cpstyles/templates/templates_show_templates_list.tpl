...
<table border="0" class="t_style_b" cellpadding="0" cellspacing="0" align="center" width="75%" dir="ltr">
<tr valign="top">
...
?>
<textarea rows="10" cols="70" wrap="virtual" tabindex="1" name="context" dir="ltr">{$CommonTemplates['template']}</textarea>&nbsp;
	</td>
	<td class="row1" valign="top">
...
<br />
<table border="0" class="t_style_b" cellpadding="0" cellspacing="0" align="center" width="40%">
<tr valign="top">
<td class="row1">
...
<br />
<table width="75%" class="t_style_b" border="1" cellspacing="8" align="center" dir="ltr">
<tr valign="top">
