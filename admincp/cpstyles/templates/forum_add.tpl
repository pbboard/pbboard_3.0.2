...
<form action="index.php?page=forums&amp;add=1&amp;start=1" method="post">
	<table width="90%" class="t_style_b" border="0" cellspacing="1" align="center">
		...
		<tr>
			...
			<td class="row2">
			<textarea name="describe" id="textarea_describe" rows="2" cols="66" dir="{$_CONF['info_row']['content_dir']}"></textarea>
			</td>
		</tr>
	</table>
	<br />
...
<td class="row1">{$lang['Make_every_prefix_subject_in_a_line']}</td>
		<td class="row1">
<textarea name="prefix_subject" id="textarea_prefix_subject" rows="4" cols="57" wrap="virtual" dir="{$_CONF['info_row']['censorwords']}"></textarea>&nbsp;
</td>
</tr>		</tr>
	</table>
<br />
	...
	<table width="90%" class="t_style_b" border="0" cellspacing="1" align="center">
		...
		<tr align="center">
			<td class="row1" colspan="2">
				<textarea name="head" rows="6" cols="100" wrap="virtual" dir="{$_CONF['info_row']['content_dir']}"></textarea>
			</td>
		</tr>
		<tr>
			<td class="main1" colspan="2">
		...
		<tr align="center">
			<td class="row1" colspan="2">
				<textarea name="foot" rows="6" cols="100" wrap="virtual" dir="{$_CONF['info_row']['content_dir']}"></textarea>
			</td>
		</tr>
	</table>
